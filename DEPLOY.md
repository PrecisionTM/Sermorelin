...
└─ images/
   ...
   ├─ pharmacy-prorx.png    ← ProRx 503b Outsourcing Facility logo
   ├─ pharmacy-prorx.svg    ← ProRx pharmacy logo (SVG variant)
   ├─ patient-result-1.jpg  ← Male before/after body composition
   ├─ patient-result-2.jpg  ← Female before/after body composition
